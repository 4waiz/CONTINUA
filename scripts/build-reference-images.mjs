...
const SLIDES = [
  {
    file: '1 (5).png',
    slide: 1,
    title: 'System Concept Sketch',
    summary:
      'The whole idea on one page: a rover leaving a facility, four candidate access networks reaching one gateway, and the observe / predict / prepare loop between them.',
  },
  {
    file: '1 (6).png',
    slide: 2,
    title: 'Route & Coverage Drawing',
    summary:
      'The four zones the route crosses — facility dock, campus, field corridor, remote hills — and where each network is available, including the handoff overlaps.',
  },
  {
    file: '1 (7).png',
    slide: 3,
    title: 'Handoff Logic Flow',
    summary:
      'Observe, Predict, Prepare, Steer, Explain as a state flow, with the inputs each stage reads and the audit record the last one writes.',
  },
  {
    file: '1 (8).png',
    slide: 4,
    ...
    summary:
      'The heuristic worked by hand: two RSSI samples, a slope, a three-second extrapolation, and the threshold crossing that triggers preparation.',
  },
  {
    file: '1 (9).png',
    slide: 5,
    title: 'Link Selection Score',
    summary:
      'The weighted utility that ranks candidate paths, with a worked comparison between two links.',
  },
  {
    file: '1 (10).png',
    slide: 6,
    ...
    summary:
      'How a run is produced: scenario generator, traffic generator, the network layer, and receiver-side logs as the only source of metrics.',
  },
  {
    file: '1 (1).png',
    slide: 7,
    title: 'Scenario Matrix & Assumptions',
    summary:
      'The six scenarios, what each one is designed to test, and the assumptions shared across all of them.',
  },
  {
    file: '1 (2).png',
    slide: 8,
    title: 'Baseline Comparison Results',
    summary:
      'Early comparison of B0, B1 and P1 on interruption, deadline misses and handoffs.',
    superseded: true,
  },
  {
    file: '1 (3).png',
    slide: 9,
    title: 'Application-Level Test Results',
    summary:
      'Early receiver-side figures: video stall, telemetry freshness, one-way delay and satellite share.',
    superseded: true,
  },
  {
    file: '1 (4).png',
    slide: 10,
    title: 'References & Evidence Notes',
    summary:
      'Literature and tools the design draws on, and the list of materials making up the evidence package.',
  },
];
